...
module Chatty
  describe ChatsController do
    ...
    let(:valid_attributes) { { "user_type" => "MyString" } }
    ...
    describe "POST create" do
      ...
      describe "with invalid params" do
        it "assigns a newly created but unsaved chat as @chat" do
          ...
          post :create, {:chat => { "user_type" => "invalid value" }}, valid_session
          assigns(:chat).should be_a_new(Chat)
        end
    ...
    describe "PUT update" do
      describe "with valid params" do
        it "updates the requested chat" do
          ...
          Chat.any_instance.should_receive(:update).with({ "user_type" => "MyString" })
          put :update, {:id => chat.to_param, :chat => { "user_type" => "MyString" }}, valid_session
        end
      ...
      describe "with invalid params" do
        it "assigns the chat as @chat" do
          ...
          # Trigger the behavior that occurs when invalid params are submitted
          Chat.any_instance.stub(:save).and_return(false)
          put :update, {:id => chat.to_param, :chat => { "user_type" => "invalid value" }}, valid_session
          assigns(:chat).should eq(chat)
        end
